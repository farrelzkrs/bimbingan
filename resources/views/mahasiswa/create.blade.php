  ...
  <div class="row">
          ...
          <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="angkatan" id="angkatan" class="form-control @error('angkatan') is-invalid @enderror" 
                value="{{ old('angkatan') }}" placeholder="2023">
              @error('angkatan')
                <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p class="small text-muted">Pastikan data mahasiswa sudah terdaftar sebagai user terlebih dahulu sebelum menambahkan data di sini.</p>
        </div>
      </div>
    </div>
  </div>
