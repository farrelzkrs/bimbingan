...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Tambah Skripsi</title>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse show" id="skripsi-menu">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link active" href="{{ route('skripsi.create') }}">Tambah Skripsi</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Tambah Skripsi Baru</h4>
                                    ...
                                    <form action="{{ route('skripsi.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" name="dokumen" id="dokumen" class="form-control @error('dokumen') is-invalid @enderror" 
                                                accept=".pdf,.docx,.doc">
                                            <small class="form-text text-muted">Format: PDF, DOCX, DOC (Max: 5MB)</small>
                                            @error('dokumen')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
