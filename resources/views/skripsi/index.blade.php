...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Daftar Skripsi</title>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse show" id="skripsi-menu">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link active" href="{{ route('skripsi.index') }}">Daftar Skripsi</a></li>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <a href="{{ route('skripsi.create') }}" class="btn btn-primary">
                                            <i class="mdi mdi-plus"></i> Tambah Skripsi
                                        </a>
                                    </div>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('skripsi.edit', $skripsi) }}" class="btn btn-sm btn-info">
                                                            <i class="mdi mdi-pencil"></i>
                                                        </a>
                                                        <form action="{{ route('skripsi.destroy', $skripsi) }}" method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
