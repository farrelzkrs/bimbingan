  ...
  <div class="row">
          ...
          <form action="{{ route('dosen.update', $dosen) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="spesialisasi" id="spesialisasi" class="form-control @error('spesialisasi') is-invalid @enderror" 
                value="{{ old('spesialisasi', $dosen->spesialisasi) }}" placeholder="Contoh: Teknologi Informasi">
              @error('spesialisasi')
                <span class="invalid-feedback">{{ $message }}</span>
              @enderror
            </div>
            ...
            <div class="mt-4">
              <button type="submit" class="btn btn-primary">
                <i class="bx bx-save"></i> Perbarui Dosen
              </button>
    ...
    <div class="col-md-4">
      <div class="card">
        ...
        <div class="card-body">
          <p class="small text-muted">Edit data dosen dengan hati-hati. Pastikan informasi NIP dan spesialisasi sudah sesuai dengan data universitas.</p>
        </div>
      </div>
    </div>
  </div>
